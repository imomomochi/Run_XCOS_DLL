      ...
      */
{
  ...
  break;
    ...
    fprintf(fprw,"%f " \
                 ...
                 "%f \n", \
                 *t,
                 *(((double *)(TestBlock_block_outtbptr+0))+0),
                 *(((double *)(TestBlock_block_outtbptr+3))+0));
    }
      ...
      */
{
  ...
  if (flag1 == 0) {
    ...
    fscanf(fprr,"%lf " \
                "%lf \n", \
                &temps,
                (double *)(TestBlock_block_outtbptr+1)+0);
    }
    else if (*flag == 5 && *nport == 1) {
      fclose(fprr);
    }
